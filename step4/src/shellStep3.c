...
/* fonction d'initialisation de la liste de breakpoints */
...
/* fonction SetBP - ajoute un breakpoint a la liste */
...
int execute_cmd_step(mips* arch,Liste_Bp* liste){
	...
	procedure=1;
		...
		do {
			...
			if(arch->reg[32].val==arch->reg[31].val-4){procedure=0;}
